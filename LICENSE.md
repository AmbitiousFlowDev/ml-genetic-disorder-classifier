   ...
   4. Redistribution.
      ...
      (d) If the Work includes a "NOTICE" file, you must include a readable
          copy of the attribution notices contained within it.
   ...
   7. Disclaimer of Warranty.
      ...
      provides the Work "AS IS", WITHOUT WARRANTIES OR CONDITIONS OF ANY
      KIND.
   ...
   9. Accepting Warranty or Additional Liability.
      ...
      warranty obligations, but only on Your own behalf.
